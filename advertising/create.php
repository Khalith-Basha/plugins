<div>
	...
	<form action="<?php echo osc_admin_render_plugin_url("ads4osc/launcher.php");?>" method="post" id="adv-form" enctype="multipart/form-data">
        ...
        <div>
            ...
            <p style="font-size:small;color:gray;"><?php _e('Ads 4 OpenSourceClassifieds will detect if the code is from a supported ad network (currently only Google Adsense)', 'ads4osc'); ?>.</p>
            <div>
