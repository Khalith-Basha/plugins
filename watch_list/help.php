    ...
    <div style="padding: 0 20px 20px;">
        <div>
            <fieldset>
                ...
                <h2>
                    <?php _e('Did Watchlist plugin work with all version of OpenSourceClassifieds?', 'watchlist') ; ?>
                </h2>
                <p>
                    <?php _e("In order to work this pluggin need OpenSourceClassifieds v2.2 and up without this version pluggin will crash", 'watchlist') ; ?>.
                </p>
                <p>
